...
basetypes.power = [
	...
	{pc:"brute",text:BS(["to become invincible while speaking",{search:"speechtype"}])},
	...
	{pc:"mover",text:BS(["of",{search:"thingy",property:"name"},"jumping"])},
	...
	{pc:"shaker",text:BS(["to cause the nearby air to behave like",{search:"substance"}])},
	{pc:"stranger",text:BS(["to become invisible to",{search:"hair"},{search:"professional"},"wearing",{search:"powerclothes"}])},
	{pc:"stranger",text:BS(["to look like",{search:"thingy",property:"name",wantarticle:true},"covered in",{search:"substance"}])},
